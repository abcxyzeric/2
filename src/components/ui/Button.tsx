...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-mystic-800 border border-mystic-accent/30 text-mystic-accent hover:bg-mystic-accent/10 hover:border-mystic-accent hover:shadow-[0_0_15px_rgba(56,189,248,0.3)]",
    ghost: "bg-transparent text-slate-400 hover:text-white hover:bg-white/5",
    outline: "border border-slate-600 text-slate-300 hover:border-slate-400 hover:text-white",
    danger: "border border-red-900/50 text-red-400 hover:bg-red-900/20 hover:border-red-500 hover:text-red-200"
  };
