...
import { TAWA_COT_PROTOCOL } from '../../../../constants/tawa_protocol';
  ...
  return (
    <div className="border border-slate-700 rounded-lg bg-slate-800/30 overflow-hidden">
      <button 
        ...
        className="w-full p-3 flex justify-between items-center text-left hover:bg-slate-700/50 transition-colors"
      >
                ...
                <div className="p-3 pt-0 space-y-3">
                    <div className="flex gap-2">
                        <select 
                            ...
                            className="flex-1 bg-slate-900 border border-slate-600 rounded p-2 text-xs text-slate-200 outline-none focus:border-mystic-accent"
                        >
                    ...
                    <div className="relative">
                         <div className="absolute top-2 right-2 text-[10px] text-slate-500 flex items-center gap-1 pointer-events-none">
                         ...
                         <textarea 
                            ...
                            className="w-full h-48 bg-slate-900/80 border border-slate-700 rounded p-2 text-[10px] font-mono text-slate-400 focus:text-slate-200 focus:border-mystic-accent outline-none resize-y custom-scrollbar leading-relaxed"
