...
const LSR_DEFAULTS: Record<string, string> = {
    ...
    'tableConfigExtraTimeFormat': 'Thứ X',
    'tableConfigRecentLimit': '5',
    'tableConfigCharacterMember': 'Nhân vật',
    ...
    'tableConfigHistoryLength': '100 token',
    'tableConfigSummaryRows': '5',
    'tableConfigSummaryLength': '200 token',
